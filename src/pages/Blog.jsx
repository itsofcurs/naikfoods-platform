...
export default function Blog() {
  ...
  return (
    <div className="w-full bg-[#FDFCF7] dark:bg-[#0B1120] min-h-screen pb-20 font-sans text-[#161915] dark:text-gray-100 transition-colors duration-300">
      {/* Top Banner */}
      ...
      <div className="container mx-auto px-4 lg:px-8 py-10">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-xl text-xs sm:text-sm font-bold transition-all whitespace-nowrap cursor-pointer ${
                selectedCategory === cat
                  ...
                  : 'bg-white dark:bg-[#131E35] text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-800 hover:border-gray-300 dark:hover:border-gray-700'
              }`}
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredBlogs.map((post) => (
            <article
              key={post.id}
              className="bg-white dark:bg-[#131E35] rounded-3xl border border-[#EAEDE9] dark:border-gray-800 overflow-hidden shadow-sm hover:shadow-md transition-all flex flex-col group"
            >
              <div className="aspect-video w-full overflow-hidden bg-gray-100 dark:bg-gray-800 relative">
                ...
                />
                <span className="absolute top-3 left-3 bg-white/95 dark:bg-[#131E35]/90 backdrop-blur-md px-3 py-1 rounded-full text-[11px] font-black text-[#70BF4F] shadow-sm uppercase border border-gray-100 dark:border-gray-700">
                  {isMr ? post.categoryMr : post.category}
                </span>
              </div>

              <div className="p-6 flex flex-col flex-grow">
                <div className="flex items-center gap-4 text-xs text-gray-400 dark:text-gray-400 mb-3 font-medium">
                ...
                <h2 className="text-xl font-bold text-gray-900 dark:text-white group-hover:text-[#70BF4F] dark:group-hover:text-[#70BF4F] transition-colors mb-2 font-serif line-clamp-2">
