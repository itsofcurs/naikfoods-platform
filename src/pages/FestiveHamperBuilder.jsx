...
const AVAILABLE_ITEMS = {
  masalas: [
    { id: 'm1', name: 'Royal Goda Masala (250g)', marathi: 'शाही गोडा मसाला', price: 210, image: 'https://images.unsplash.com/photo-1615485290382-441e4d049cb5?w=200&auto=format&fit=crop&q=60' },
    { id: 'm2', name: 'Kolhapuri Kanda Lasun Masala (250g)', marathi: 'कोल्हापुरी कांदा लसूण', price: 180, image: 'https://images.unsplash.com/photo-1596040033229-a9821ebd058d?w=200&auto=format&fit=crop&q=60' },
    { id: 'm3', name: 'Sindhudurg Malvani Masala (250g)', marathi: 'मालवणी मसाला', price: 220, image: 'https://images.unsplash.com/photo-1596040033229-a9821ebd058d?w=200&auto=format&fit=crop&q=60' },
    { id: 'm4', name: 'Nagpuri Saoji Garam Masala (200g)', marathi: 'सावजी गरम मसाला', price: 230, image: 'https://images.unsplash.com/photo-1615485290382-441e4d049cb5?w=200&auto=format&fit=crop&q=60' },
    { id: 'm5', name: 'Khandeshi Charred Kala Masala (250g)', marathi: 'खान्देशी काळा मसाला', price: 215, image: 'https://images.unsplash.com/photo-1596040033229-a9821ebd058d?w=200&auto=format&fit=crop&q=60' },
  ],
  pickles: [
    { id: 'p1', name: 'Konkani Kairi Lonche (300g)', marathi: 'कैरीचे लोणचे', price: 190, image: 'https://images.unsplash.com/photo-1621996346565-e3d5d62810ef?w=200&auto=format&fit=crop&q=60' },
    { id: 'p2', name: 'Solapuri Shengdana Chutney (200g)', marathi: 'सोलापुरी शेंगदाणा चटणी', price: 140, image: 'https://images.unsplash.com/photo-1621996346565-e3d5d62810ef?w=200&auto=format&fit=crop&q=60' },
    { id: 'p3', name: 'Kolhapuri Mirchi Thecha (200g)', marathi: 'झणझणीत मिरची ठेचा', price: 150, image: 'https://images.unsplash.com/photo-1621996346565-e3d5d62810ef?w=200&auto=format&fit=crop&q=60' },
    { id: 'p4', name: 'Dry Garlic Lasun Chutney (150g)', marathi: 'कोरडी लसूण चटणी', price: 130, image: 'https://images.unsplash.com/photo-1596040033229-a9821ebd058d?w=200&auto=format&fit=crop&q=60' },
  ],
  snacks: [
    { id: 's1', name: 'Authentic Puneri Bakarwadi (400g)', marathi: 'पुणेरी बाकरवडी', price: 160, image: 'https://images.unsplash.com/photo-1601050690597-df0568f70950?w=200&auto=format&fit=crop&q=60' },
    { id: 's2', name: 'Ratnagiri Alphonso Amba Poli (200g)', marathi: 'हापूस आंबा पोळी', price: 240, image: 'https://images.unsplash.com/photo-1553279768-865429fa0078?w=200&auto=format&fit=crop&q=60' },
    { id: 's3', name: 'Vidarbha Spiced Poha Chivda (350g)', marathi: 'खमंग पोहे चिवडा', price: 140, image: 'https://images.unsplash.com/photo-1601050690597-df0568f70950?w=200&auto=format&fit=crop&q=60' },
    { id: 's4', name: 'Traditional Besan Ladoo with Desi Ghee (300g)', marathi: 'शुद्ध तुपातले बेसन लाडू', price: 220, image: 'https://images.unsplash.com/photo-1549465220-1a8b9238cd48?w=200&auto=format&fit=crop&q=60' },
  ]
};
...
export default function FestiveHamperBuilder() {
  ...
  const handleAddHamperToCart = () => {
    ...
    const hamperProduct = {
      ...
      title: `Custom Gift Hamper: ${selectedBox.title}`,
      thumbnail: selectedBox.image,
      handle: 'custom-festive-hamper',
      description: `Includes: ${[...selectedMasalas, ...selectedPickles, ...selectedSnacks].map(i => i.name).join(', ')}. Greeting: "${greeting.message}" from ${greeting.from}`
    };
      ...
      <div className="max-w-[1300px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10">
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-amber-500 to-orange-500 text-white px-4 py-1.5 rounded-full text-xs font-black uppercase tracking-wider mb-3 shadow-md">
            <Gift className="w-3.5 h-3.5" /> सण-उत्सव भेट • Festive Custom Box Builder
          </div>
          <h1 className="text-3xl sm:text-5xl font-black text-gray-900 tracking-tight">
            Build Your Own <span className="text-[#70BF4F]">Maharashtrian Hamper</span>
          </h1>
          <p className="mt-3 text-base text-gray-600">
            Pick 2 Masalas + 2 Pickles/Chutneys + 2 Snacks & Sweets in a handcrafted festive gift box with a personalized greeting card. Enjoy an automatic <strong className="text-[#70BF4F]">15% Bundle Discount</strong>!
          </p>
        </div>
          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            <div className="bg-white rounded-3xl p-6 sm:p-8 border border-gray-200/80 shadow-xs">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h2 className="text-lg font-black text-gray-900">Choose Your Gift Packaging</h2>
                  <p className="text-xs text-gray-500">Premium festive finish with complimentary packaging</p>
                </div>
              </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between mb-1">
                        <h3 className="font-black text-sm text-gray-900">{box.title}</h3>
                        {isSelected && <Check className="w-4 h-4 text-[#70BF4F]" />}
                      </div>
                      <p className="text-[11px] text-[#70BF4F] font-bold">{box.marathi}</p>
                      <p className="text-xs text-gray-500 mt-1 leading-snug">{box.tagline}</p>
                    </div>
                  );
                })}
              </div>
            ...
            <div className="bg-white rounded-3xl p-6 sm:p-8 border border-gray-200/80 shadow-xs space-y-8">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-lg font-black text-gray-900">Curate Your 6 Maharashtrian Items</h2>
                  <p className="text-xs text-gray-500">Choose 2 Masalas + 2 Pickles/Chutneys + 2 Crispy Snacks</p>
                </div>
              </div>
                ...
                <div className="flex items-center justify-between mb-3">
                  ...
                  {selectedMasalas.length === 2 && (
                    <span className="text-xs font-bold text-green-600 bg-green-50 px-2 py-0.5 rounded-full flex items-center gap-1">
                      <Check className="w-3 h-3" /> Slot Filled
                    </span>
                  )}
                </div>
                      ...
                      >
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <div className="min-w-0">
                            ...
                            <p className="text-[10px] text-gray-500">{item.marathi}</p>
                          </div>
                        </div>
            ...
            <div className="bg-white rounded-3xl p-6 sm:p-8 border border-gray-200/80 shadow-xs">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h2 className="text-lg font-black text-gray-900">Add Personalized Handwritten Greeting Card</h2>
                  <p className="text-xs text-gray-500">Free embossed greeting card enclosed inside the box</p>
                </div>
              </div>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                <div>
                  <label className="block text-xs font-bold uppercase tracking-wider text-gray-600 mb-1">Occasion / सण</label>
                  <select
                  ...
                  >
                    ...
                    <option value="Just Because / घरची चव">Just Because / घरची चव</option>
                  </select>
                </div>

                <div>
                  <label className="block text-xs font-bold uppercase tracking-wider text-gray-600 mb-1">Recipient Name (To)</label>
                  <input
                    type="text"
                    value={greeting.to}
                    onChange={(e) => setGreeting({ ...greeting, to: e.target.value })}
                    placeholder="e.g. Aai & Baba / Sharma Family"
                    className="w-full bg-gray-50 border border-gray-200 rounded-xl p-3 text-sm font-semibold text-gray-800"
                  />
                </div>
              </div>
              ...
              <div>
                <label className="block text-xs font-bold uppercase tracking-wider text-gray-600 mb-1">Personalized Message (मनातले शब्द)</label>
                <textarea
                  rows={2}
              ...
              <div className="mt-4">
                <label className="block text-xs font-bold uppercase tracking-wider text-gray-600 mb-1">Sender Signature (From)</label>
                <input
                  type="text"
                  value={greeting.from}
                  onChange={(e) => setGreeting({ ...greeting, from: e.target.value })}
                  placeholder="e.g. With lots of love from Rohan & Family"
                  className="w-full bg-gray-50 border border-gray-200 rounded-xl p-3 text-sm font-semibold text-gray-800"
                />
              </div>
            </div>
          ...
          <div className="lg:col-span-4 sticky top-28 space-y-6">
            <div className="bg-white rounded-3xl p-6 border border-gray-200/80 shadow-xl overflow-hidden relative">
              ...
              <h2 className="text-xl font-black text-gray-900 mb-1 flex items-center gap-2">
                <Package className="w-5 h-5 text-[#70BF4F]" /> Your Custom Hamper
              </h2>
              <p className="text-xs text-gray-500 mb-4">{selectedBox.title} ({selectedBox.marathi})</p>
              ...
              <div className="bg-gray-50 p-3.5 rounded-2xl border border-gray-100 mb-6">
                <div className="text-xs font-bold text-gray-700 mb-2.5 flex items-center justify-between">
                  <span>Box Slots ({[...selectedMasalas, ...selectedPickles, ...selectedSnacks].length}/6)</span>
                  {isComplete ? (
                    <span className="text-green-600 text-[11px] font-black">Ready to Pack! 🎁</span>
                  ) : (
                    <span className="text-amber-600 text-[11px] font-black">Fill all 6 slots</span>
                  )}
                </div>
                ...
                <div className="grid grid-cols-3 gap-2">
                  {[...selectedMasalas, ...selectedPickles, ...selectedSnacks].map((item, idx) => (
                    <div key={idx} className="bg-white p-1.5 rounded-xl border border-gray-200 text-center relative group">
                      ...
                      <p className="text-[10px] font-bold text-gray-800 truncate">{item.name.split(' ')[0]}</p>
                  ...
                  {Array.from({ length: Math.max(0, 6 - [...selectedMasalas, ...selectedPickles, ...selectedSnacks].length) }).map((_, i) => (
                    <div key={`empty_${i}`} className="border-2 border-dashed border-gray-300 rounded-xl flex flex-col items-center justify-center p-3 text-gray-400">
                      ...
                      <span className="text-[9px] font-bold">Slot {i + 1}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="space-y-2.5 text-sm mb-6 pt-2 border-t border-gray-100">
                <div className="flex justify-between text-gray-600">
                  <span>6 Authentic Items Total</span>
                  <span className="font-bold text-gray-900">₹{rawTotal}</span>
                </div>
                <div className="flex justify-between text-gray-600">
                  <span>Premium Gift Box & Ribbon</span>
                  <span className="font-bold text-green-600"><span className="line-through text-gray-400 mr-1.5">₹{selectedBox.boxValue}</span> FREE</span>
                </div>
                <div className="flex justify-between text-green-700 font-bold bg-green-50 p-2 rounded-xl">
                  <span>Custom Hamper 15% Discount</span>
                  <span>-₹{discountAmount}</span>
                </div>
                <div className="flex justify-between items-baseline pt-3 border-t border-gray-200">
                  <div>
                    <span className="text-xs font-bold text-gray-500 uppercase tracking-wider block">Total Festive Bundle</span>
                    <span className="text-2xl font-black text-gray-900">₹{finalPrice}</span>
                  </div>
                  <div className="text-right">
                    <span className="text-xs font-extrabold text-amber-600 block">🪙 Earns {Math.floor(finalPrice * 0.05)} Swad Coins</span>
                  </div>
                </div>
              </div>
              ...
              >
                ...
                {isComplete ? 'Add Complete Hamper to Cart' : `Select ${6 - [...selectedMasalas, ...selectedPickles, ...selectedSnacks].length} More Items`}
              </button>
              ...
              <div className="mt-4 text-center">
                <p className="text-[11px] text-gray-500 flex items-center justify-center gap-1">
                  ...
                  FSSAI Verified & Freshly Packed Before Dispatch
                </p>
              </div>
            </div>
          </div>
