      ...
      >
        ...
        <div className="bg-gradient-to-br from-amber-500 via-amber-600 to-orange-600 p-6 text-white relative">
          ...
          <div className="flex items-center gap-2 text-amber-200 font-bold text-xs uppercase tracking-wider mb-1">
            <Coins className="w-4 h-4" /> Naik Swad Rewards Club
          </div>
          
          <div className="flex items-end justify-between mt-2">
            <div>
              <p className="text-sm text-amber-100 font-medium">Your Swad Coins Balance</p>
              <div className="flex items-baseline gap-2 mt-1">
                <span className="text-4xl font-black tracking-tight">{coins}</span>
                <span className="text-amber-200 font-bold text-sm">Coins (₹{coins})</span>
              </div>
            </div>
        ...
        <div className="p-6 overflow-y-auto space-y-6 flex-1">
          ...
          <div className="bg-amber-50/80 border border-amber-200/70 rounded-2xl p-4">
            <div className="flex items-center justify-between mb-2">
              <span className="text-xs font-bold uppercase tracking-wider text-amber-900">Current Tier Perks</span>
            ...
            {tier.nextTier && (
              <div className="mt-3 pt-3 border-t border-amber-200/60">
                <div className="flex justify-between text-xs font-bold text-gray-600 mb-1">
                  ...
                  <span className="text-amber-700">{tier.coinsNeeded} coins to unlock</span>
                </div>
          ...
          {/* How to Earn */}
          <div>
            <h4 className="text-xs font-black uppercase tracking-wider text-gray-500 mb-3">How to Earn More Swad Coins</h4>
            <div className="grid grid-cols-2 gap-2.5">
              <div className="p-3 rounded-xl border border-gray-100 bg-gray-50/70 flex flex-col justify-between">
                ...
                <div>
                  <p className="text-xs font-bold text-gray-900">Shop Any Product</p>
                  <p className="text-[11px] text-gray-500">Earn 5% back on every order</p>
                </div>
              </div>
              ...
              <div className="p-3 rounded-xl border border-gray-100 bg-gray-50/70 flex flex-col justify-between">
                ...
                <div>
                  <p className="text-xs font-bold text-gray-900">Write a Review</p>
                  <p className="text-[11px] text-gray-500">Get +25 Coins per photo review</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Coin History */}
          <div>
            <h4 className="text-xs font-black uppercase tracking-wider text-gray-500 mb-3">Activity History</h4>
